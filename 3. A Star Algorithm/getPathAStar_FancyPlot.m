...
%the A* algorithm. It also generates a plot as it works along the algorithm
%which can be used to identify the behaviour.
%
% Inputs:
...
%
%---------------------------------------------------------
function path = getPathAStar_FancyPlot(lenx, leny, objLoc, objSize, res, startCart, goalCart, w)
